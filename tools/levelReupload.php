...
1. Copiar la ID del nivel del GD<br>
2. Pegarla en donde dice "ID" (Puedes cambiar la URL a otro servidor, haciendo que puedas resubir un nivel de un GDPS a otro GDPS)<br>
